...
class DemoExportConfig extends ExportConfig
{
    ...
    /**
     *  输出类型
     *    OUT_PUT_TYPE_UPLOAD  上传 filesystem  配置 path
     *    OUT_PUT_TYPE_LOCAL   保存到本地        配置 path
     *    OUT_PUT_TYPE_OUT     直接输出         配置 path
     * @var string 
     */
    ...
    public function getPath()
    {
         ...
         // 直接输出 demo.xlsx
         return  'demo_'. date('Y_m_d_H_i_s_u') . '.xlsx';
    }
}
...
class DemoImportConfig extends ImportConfig
{
     ...
     *
     * @param array $row  行数据
     * @param ExcelAbstract $excel excel操作对象
